...
TEST_CASE("Sequential Byte STL container 5", "[classic]") {
	...
	std::vector<int> vec1 = vec, vec2 = vec;
	clock_t begin_time = clock();
	sort::radix_byte_sort_stl_containers(vec1);
	std::cout << float(clock() - begin_time) / CLOCKS_PER_SEC << std::endl;
	writeResult("Radix Byte", "Sequential", "STL vector", N, 5, float(clock() - begin_time) / CLOCKS_PER_SEC);
...
TEST_CASE("Sequential Byte STL container 9", "[classic]") {
	...
	sort::radix_byte_sort_stl_containers(vec1);
	std::cout << float(clock() - begin_time) / CLOCKS_PER_SEC << std::endl;
	writeResult("Radix Byte", "Sequential", "STL vector", N, 9, float(clock() - begin_time) / CLOCKS_PER_SEC);
...
TEST_CASE("Sequential Byte dynamic array( N = 4000000) 5", "[classic]") {
	...
	clock_t begin_time = clock();
	sort::radix_byte_sort_arrays<int>(arr, N);
	std::cout << float(clock() - begin_time) / CLOCKS_PER_SEC << std::endl;
	writeResult("Radix Byte", "Sequential", "Dynamic Array", N, 5, float(clock() - begin_time) / CLOCKS_PER_SEC);
...
TEST_CASE("Sequential Byte dynamic array( N = 4000000) 9", "[classic]") {
	...
	sort::radix_byte_sort_arrays<int>(arr, N);
	std::cout << float(clock() - begin_time) / CLOCKS_PER_SEC << std::endl;
	writeResult("Radix Byte", "Sequential", "Dynamic Array", N, 9, float(clock() - begin_time) / CLOCKS_PER_SEC);
...
TEST_CASE("Parallel Radix Byte TBB dynamic array( N = 4000000) 5", "[classic]") {
	...
	std::cout << float(clock() - begin_time) / CLOCKS_PER_SEC << std::endl;
	writeResult("Radix Byte", "Parallel TBB", "Dynamic Array", N, 5, float(clock() - begin_time) / CLOCKS_PER_SEC);
